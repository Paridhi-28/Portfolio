...
const EmailSection = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Form the request for sending to the server
        const options = {
    ...
    return (
        <section className='grid md:grid-cols-2 my-12md:my-12 py-24 gap-4 relative'>
            <div className='bg-[radial-gradiet(ellipse_at_center,_var(--tw-gradient-stops))] from-[#D13ABD] to-transparent rounded-full h-80 w-80 z-0 blur-lg absolute top-3/4 -left-4 transform -translate-x-1/2 -translate-y-1/2'>..</div>
            <div className='z-10'>
            ...
            <div>
                ...
                rounded-lg block w-full p-2.5'
                    ...
                    <button type='submit'
                    className='bg-[#D13ABD] hover:bg-[#921381] text-white font-medium py2.5 px-2.5 rounded-lg w-full h-10'>
                        Send Message
                    </button>
                    {
                        // If the email was submitted succesfully, show a success message.
                        emailSubmitted && (
                            <p className='text-green-500 text-sm mt-2'></p>
                        )
                    }
                </form>
            </div>
